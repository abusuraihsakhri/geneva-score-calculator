"""
Command Line Interface for Geneva Score Calculator.
"""
import argparse
import csv
import sys
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="geneva-score-calculator", description="Geneva Score Calculator")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  GENEVA SCORE CALCULATOR")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Geneva Score Calculator Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Geneva Score Calculator API server on http://{args.host}:{args.port}")
